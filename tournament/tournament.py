...
from randgameplayer import RandGamePlayer
...
class Tournament:
    ...
    def playGame(self, gameIndex, currentRound, 
        ...
        if (rand == "1"):
            gamePlayer = RandGamePlayer(black, white, self._size)
        else:
        ...
        gamePlayer.saveProject(name + ".out", name, resultBlack, resultWhite)
        if error:
            print "Error: Game", gameIndex, errorMessage
        ...
        for i in range(first, self._rounds*gamesPerRound):
            ...
            if ((i % 2) == 0):
                self.playGame(i, currentRound,
                              ...
                              opening, self._verbose, self._rand)
            else:
                self.playGame(i, currentRound,
                              self._p2name, self._p2cmd,
                              self._p1name, self._p1cmd,
